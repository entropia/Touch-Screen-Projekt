...
extern int BV055HDE_loaded_state;
					 ...
					 const struct i2c_device_id *id)
{
	...
	printk(KERN_WARNING "ft5x06_ts_probe. BV055HDE_loaded_state=%d\n", 
		BV055HDE_loaded_state);

	if (BV055HDE_loaded_state == 0) {
		return -EPROBE_DEFER;
	}
...
MODULE_SOFTDEP("pre: panel-TSD-BV055HDE");